...
{
    sealed class KernelHybrid : ClKernel, IDisposable
    {
        private const string KERNEL_NAME = "Hybrid";
        

        public KernelHybrid(Context context, CommandQueue commandQueue, OpenCL.Net.Program program, out ErrorCode error) 
