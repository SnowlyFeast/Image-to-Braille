...
{
    sealed class KernelSobel : ClKernel, IDisposable
    {
        private const string KERNEL_NAME = "Sobel";
        

        public KernelSobel(Context context, CommandQueue commandQueue, OpenCL.Net.Program program, out ErrorCode error) 
