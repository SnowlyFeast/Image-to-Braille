...
{
    sealed class KernelGammaCorrection : ClKernel, IDisposable
    {
        private const string KERNEL_NAME = "GammaCorrection";
        

        public KernelGammaCorrection(Context context, CommandQueue commandQueue, OpenCL.Net.Program program, out ErrorCode error) 
        ...
        protected override void Setup(out ErrorCode error, params object[] args)
        {
            ...
            SetKernelArg(args[2], 2, ObjectType.Double, out error);
        }
