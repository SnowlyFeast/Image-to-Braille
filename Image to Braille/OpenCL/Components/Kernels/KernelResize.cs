...
{
    sealed class KernelResize : ClKernel, IDisposable
    {
        private const string KERNEL_NAME = "Resize";
        

        public KernelResize(Context context, CommandQueue commandQueue, OpenCL.Net.Program program, out ErrorCode error) 
