...
{
    sealed class KernelQuantize : ClKernel, IDisposable
    {
        private const string KERNEL_NAME = "Quantize";
        

        public KernelQuantize(Context context, CommandQueue commandQueue, OpenCL.Net.Program program, out ErrorCode error) 
        ...
        protected override void Setup(out ErrorCode error, params object[] args)
        {
            ...
            SetKernelArg(args[2], 2, ObjectType.Int, out error);
        }
